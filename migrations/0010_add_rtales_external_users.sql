...
CREATE INDEX external_users_lookup_idx ON external_users (rtales_lookup_code_normalized);
...
ALTER TABLE player_sessions ADD COLUMN external_user_id UUID REFERENCES external_users(id);
...
ALTER TABLE receipts ADD COLUMN external_user_id UUID REFERENCES external_users(id);
